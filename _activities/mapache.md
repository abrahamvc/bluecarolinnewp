...
¡También se encuentra mi libro de Arduino!

- <img class="md-icon" src="{{ '/assets/icons/star.svg' | relative_url }}" alt="Star Icon"> 
<a href="https://www.lamapacheazul.cl" 
    class="btn-link"
    target="blank"
    rel="noopener noreferrer">
    Página web : La Mapache Azul
</a>

- <img class="md-icon" src="{{ '/assets/icons/star.svg' | relative_url }}" alt="Star Icon"> 
<a href="https://www.instagram.com/lamapacheazul.cl" 
    class="btn-link"
    target="blank"
    rel="noopener noreferrer">
    Instagram : La Mapache Azul
</a>

- <img class="md-icon" src="{{ '/assets/icons/star.svg' | relative_url }}" alt="Star Icon"> 
<a href="https://www.lamapacheazul.cl/product-page/kit-arduino" 
    class="btn-link"
    target="blank"
    rel="noopener noreferrer">
